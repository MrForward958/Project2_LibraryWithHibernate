...
@EnableWebMvc
//Указываем где лижит файл для подключения hibernate
...
//    }
    ...
    //Метод для получание с файла hibernate.properties, свойст для hibernate с помощью окружающей среды(environment)
...
//    //Бин для sessionFactory, создатель сессии. Содержит всю инфрмацию для создания сессии
...
//    //Бин для спринга, как работать с транзакциями, руководство для аннотации @EnableTransactionManagement
//    @Bean
